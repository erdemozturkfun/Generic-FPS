...
public class Movement : MonoBehaviour
{
    ...
    private void pMovement()
    {
        ...
        if (readyToJump && jumping){ Jump(); audioSource.enabled = false;}
